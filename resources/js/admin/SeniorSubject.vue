<template>
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-calendar-plus-o"></i> Senior High School Subjects</h1>
                <p>Set up SHS Subjects</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-5">
                    <div class="tile">
                        <h3 class="tile-title">SHS Subjects</h3>
                        <div class="tile-body">
                        ...
                        <div class="row">
                            ...
                            <button class="btn btn-primary" @click="saveSeniorSubject()" type="button"><i class="fa fa-fw fa-lg fa-save"></i>{{btncap}}</button>
                            &nbsp;&nbsp;&nbsp;
                ...
                <div class="col-md-7">
                    <div class="tile">
                        <!-- <div class="overlay" v-if="seniorsubjects.length == 0">
                        ...
                        <div class="tile-body">
                            ...
                            <data-table class="mt-2" :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sort="sortBy">
                                <tbody>
                                    <tr class="tr-shadow" v-for="(list, idx) in seniorsubjects" :key="idx">
                                        ...
                                        <td>
                                            <div class="table-data-feature">
                                                <button class="btn btn-primary btn-sm" data-toggle="tooltip" @click="editSenior(list)" title="Edit">
                                    ...
                                    <tr> 
                                        <td colspan="4" v-show="!noData(seniorsubjects)">
                                            No Result Found!
                                        </td>
                                    </tr>
                                    <tr class="spacer"></tr>
...
export default {
    ...
    methods: {
        saveSeniorSubject(){
            if(this.post.id > 0){
                this.$axios.get('sanctum/csrf-cookie').then(response=>{
                    this.btncap = "Saving..."
                    this.$axios.put('api/senior-subject/'+this.post.id, this.post).then(res=>{
                        this.post = {};
                        this.btncap = "Save"
                        this.$emit('show',{'message':'Subject has been modified!'});
                        this.listOfSeniorSubject();
                        this.errors = [];
                    }).catch(err=>{
                        this.btncap = "Save"
                ...
                this.$axios.get('sanctum/csrf-cookie').then(response=>{
                    this.btncap = "Saving..."
                    this.$axios.post('api/senior-subject', this.post).then(res=>{
                        this.post = {};
                        this.btncap = "Save"
        ...
        listOfSeniorSubject(urls='api/senior-subject'){
            this.$axios.get('sanctum/csrf-cookie').then(response => {
                this.tableData.draw ++;
                this.$axios.get(urls,{params:this.tableData}).then(res=>{
                let data = res.data;
                    if(this.tableData.draw == data.draw){
                        this.seniorsubjects = data.data.data;
