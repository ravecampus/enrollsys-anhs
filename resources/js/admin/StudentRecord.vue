<template>
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-file-text"></i> Student Record</h1>
                <!-- <p>Set up Students</p> -->
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="card mb-5 mt-3">
                        <div class="card-body">
                            <div class="form-group">
                                <input type="text" class="form-control" v-model="tableData.search" @input="listOfStudent()" placeholder="Search...">
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr v-for="(lis, idx) in students" :key="idx">
                                            <td>{{ lis.last_name }}, {{ lis.first_name }} {{ lis.middle_name }}</td>
                                            <td>
                                                <button type="button" @click="viewUser(lis)" class="btn btn-sm btn-primary">
                                                    <i class="fa fa-eye"></i>
                                                </button>
                                            </td>
                                        </tr>
...
export default {
    ...
    methods: {
        ...
        viewUser(data){
            ...
            // this.data2 = {};
            this.post = data;
            this.$emit('show',{'message':'PLease check on the top for other information!'});
