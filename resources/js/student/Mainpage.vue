...
<div>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><router-link class="app-menu__item" :to="{name:'schedule'}"><i class="app-menu__icon fa fa-history"></i><span class="app-menu__label">Enrollment History</span></router-link></li>
